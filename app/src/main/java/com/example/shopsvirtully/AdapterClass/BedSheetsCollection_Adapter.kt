...
class BedSheetsCollection_Adapter(var context: Context,var bedsheetcollection:ArrayList<BedSheetCollection_Data>): RecyclerView.Adapter<BedSheetsCollection_Adapter.ViewHolder>() {
